...
use project_work::GymWorkout;


fn main() {
    // let cardio_exercise = cardio::Exercise{
    //     day:"Monday",
    //     tool: cardio::CardioTool::Treadmill,
    //     minutes: 90
    // }

    // let weightlifting_exercise = weightlifting::Exercise{
    //     name:"Poorvanshi",
    //     reps: 34
    // }

    let gym = GymWorkout::new();
    println!("{:?}", gym);
}
