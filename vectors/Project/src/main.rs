...
fn main() {
    let mut folder_instance = Folder::new(String::from("poorvanshi"));

    folder_instance.create_file(String::from("pop"));
    folder_instance.create_file(String::from("gop"));

    println!("{:#?}", folder_instance);

    folder_instance.delete_file(0);
    folder_instance.delete_file(0);

    println!("{:#?}", folder_instance);

    let res = folder_instance.get_file(0);
